...
import '../../hiragana/widgets/stroke_painter.dart';

/// Writing dialog showing KanjiVG stroke animation for Katakana
class KatakanaWritingDialogWidget extends StatefulWidget {
  final KatakanaModel katakana;

  const KatakanaWritingDialogWidget({
    super.key,
    required this.katakana,
  });

  @override
  State<KatakanaWritingDialogWidget> createState() => _KatakanaWritingDialogWidgetState();
}

class _KatakanaWritingDialogWidgetState extends State<KatakanaWritingDialogWidget>
  ...
  Future<void> _loadStrokes() async {
    debugPrint('=== Loading Strokes for ${widget.katakana.character} ===');
    ...
    try {
      final paths = await _kanjiVGService.loadStrokePaths(widget.katakana.character, "katakana");
